...
contract EOFeedVerifierInitialize is UninitializedFeedVerifier {
    function test_RevertWhen_Initialize_InvalidAddress() public {
        ...
        feedVerifier.initialize(address(this), blsNull);
    }
...
contract EOFeedVerifierTest is InitializedFeedVerifier {
    ...
    function test_verify() public {
        ...
        feedVerifier.verify(input, vParams);
        assertEq(feedVerifier.lastProcessedBlockNumber(), blockNumber1);
        assertEq(feedVerifier.lastProcessedEventRoot(), merkleRoot1);
    }
    ...
    function test_RevertWhen_InsufficientVotingPower_Verify() public {
        ...
        IEOFeedVerifier.VerificationParams memory vParams = _getNotEnoughVotingPowerVerificationParams();
    ...
    function test_batchVerify() public {
        ...
        inputs[0] = _getDefaultInputLeaf();
        feedVerifier.batchVerify(inputs, vParams);
    }
